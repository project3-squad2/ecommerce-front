...
/***/ function(module, exports, __webpack_require__) {
	...
	var cartEvents = __webpack_require__(32);

	var stripeEvents = __webpack_require__(33);
	var orderEvents = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var closeModalSignUp = function closeModalSignUp() {
	...
	var closeModalSignIn = function closeModalSignIn() {
	...
	var closeModalChangePassword = function closeModalChangePassword() {
	...
	var closeModalSignOut = function closeModalSignOut() {
	...
	var uploadMonster = function uploadMonster() {
	  ...
	  $.ajax({
	    ...
	    processData: false,
	    data: data
	  }).done(ui.uploadSuccess).fail(function (err) {
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#admin').on('click', '.delete-monster', function (event) {
	    event.preventDefault();
	    var id = $(event.target).attr("data-monster-id");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inCart = function inCart(val) {
	  if (this[1] === val.name) {
	...
	var updateTotal = function updateTotal() {
	  ...
	  cartObj.total = itemTotal.reduce(function (pv, cv) {
	    return pv + cv;
	  }, 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  onSuccess: onSuccess,
	  successMonster: successMonster,
	  app: app,
	  failureSignIn: failureSignIn,
	  successMonsters: successMonsters,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n      <div class=\"content\">\n        <img src=\""
	    ...
	    + "</h5>\n\n        <button type=\"button\" class=\"btn btn-warning delete-monster\" data-monster-id=\""
	    + alias1(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"_id","hash":{},"data":data}) : helper)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.monsters : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"single-monster\">\n  <img src="
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.name : stack1), depth0))
	    + " </p>\n  <p><b>DESCRIPTION:</b> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.description : stack1), depth0))
	    + " <p>\n  <form id=\"form\">\n    <fieldset>\n      <p><b>QUANTITY:</b> <input type=\"number\" min=\"1\" placeholder=\"1\"></p>\n      <input type=\"text\" style=\"display: none\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.name : stack1), depth0))
	    + "\">\n      <input type=\"number\" style=\"display: none\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.price : stack1), depth0))
	    + "\">\n      <input type=\"text\" style=\"display: none\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\">\n    </fieldset>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onRemoveFromCart = function onRemoveFromCart(event) {
	  ...
	  var arr = cartStorage.cartObj.items;
	...
	var onChangeQuant = function onChangeQuant(event) {
	  ...
	  var index = cartStorage.cartObj.items.findIndex(function (val) {
	    return val.name === id;
	  });
	  var target = cartStorage.cartObj.items[index];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  addStripeCharge: addStripeCharge,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  changePaidStatusSuccess: changePaidStatusSuccess
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getOrderSuccess = function getOrderSuccess(data) {
	  ...
	  var previousOrders = "<table class = 'order-table'> <tr> <th>Date Purchased</th> <th>Monster</th> <th>Price</th> <th>Quantity</th> <th>Total</th> </tr>";
	  for (var i = 0; i < app.orders.length; i++) {
	    //get the total for each order
	    var currentTotal = app.orders[i].total;
	    //get the date of each order
	    var date = app.orders[i].createdAt.slice(0, 10).split('-');
	    var displayDate = date[1] + '/' + date[2] + '/' + date[0];
	    //for each item in an order
	    for (var j = 0; j < app.orders[i].items.length; j++) {
	      //order date
	      if (j === 0) {
